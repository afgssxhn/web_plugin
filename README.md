...
✅ **GeoIP кэширование** - страны кэшируются на 24 часа (настраивается)
✅ **Система разрешений** - контроль доступа к командам
✅ **Конфигурационный файл** - все настройки в `config.yml`
✅ **Исправлен порядок игроков** - теперь игроки отображаются в правильном порядке
✅ **Убран Thread.sleep** - больше никаких лагов при `/webe`
✅ **Улучшенная производительность** - асинхронная работа и кэширование
...
Скомпилированный .jar будет в `target/Web-1.3.0.jar`

## Установка

1. Скопируй `Web-1.3.0.jar` в папку `plugins/` твоего сервера
